...
// POST /:code — consumes a one-time link (confirm page form posts here)
...
// POST /img/:code — consumes a one-time image (confirm page form posts here)
...
export { expiryUrl, generateShortCode, parseDuration, parseOneTime, oneTimeConfirmResponse, checkRateLimit, getClientIp, RATE_LIMITS } from './lib/utils';
